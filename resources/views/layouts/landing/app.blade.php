        ...
        <div class="navbar-bottom">
            ...
            <div class="container">
                ...
                <div class="navbar-bottom-wrapper">
                    ...
                    @php($baseUrl = 'https://eg-admin.twissta.com')

                    <a href="{{ $baseUrl }}" class="logo">
                        <img class="onerror-image"  data-onerror-image="{{ asset('assets/admin/img/160x160/img2.jpg') }}" src="{{\App\CentralLogics\Helpers::get_full_url('business', $fav?->value?? '', $fav?->storage[0]?->value ?? 'public','favicon')}}" alt="image">
                    </a>

                    <ul class="menu">
                        <li>
                            <a id="home-link" href="{{ $baseUrl }}" class="{{ Request::is('/') ? 'active' : '' }}"><span>{{ translate('messages.home') }}</span></a>
                        </li>
                        <li>
                            <a href="{{ $baseUrl }}/about-us" class="{{ Request::is('about-us') ? 'active' : '' }}"><span>{{ translate('messages.about_us') }}</span></a>
                        </li>
                        <li>
                            <a href="{{ $baseUrl }}/privacy-policy" class="{{ Request::is('privacy-policy') ? 'active' : '' }}"><span>{{ translate('messages.privacy_policy') }}</span></a>
                        </li>
                        <li>
                            <a href="{{ $baseUrl }}/terms-and-conditions" class="{{ Request::is('terms-and-conditions') ? 'active' : '' }}"><span>{{ translate('messages.terms_and_condition') }}</span></a>
                        </li>
                        <li>
                            <a href="{{ $baseUrl }}/contact-us"  class="{{ Request::is('contact-us') ? 'active' : '' }}"><span>{{ translate('messages.contact_us') }}</span></a>
                        </li>
                    ...
                    @if ($lang)
                        <div class="dropdown--btn-hover position-relative">
                            <a class="dropdown--btn border-0 px-3 header--btn text-capitalize d-flex" style="cursor: pointer;">
                    ...
                    <a href="/login/store" class="dropdown--btn header--btn text-capitalize d-flex align-items-center">
            ...
            <div class="container">
                <div class="footer-wrapper ps-xl-5">
                    ...
                    <div class="footer-widget widget-links">
                        ...
                        <ul>
                            <li>
                                <a href="{{ $baseUrl }}/privacy-policy">{{ translate('messages.privacy_policy') }}</a>
                            </li>
                            <li>
                                <a href="{{ $baseUrl }}/terms-and-conditions">{{ translate('messages.terms_and_condition') }}</a>
                            </li>

                            @if (isset($landing_data['refund_policy_status']) && $landing_data['refund_policy_status']  == 1)
                            <li>
                                <a href="{{ $baseUrl }}/refund">{{ translate('messages.Refund Policy') }}</a>
                            </li>
                            @endif
                            @if (isset($landing_data['shipping_policy_status']) && $landing_data['shipping_policy_status']  == 1)
                            <li>
                                <a href="{{ $baseUrl }}/shipping-policy">{{ translate('messages.Shipping Policy') }}</a>
                            </li>
                            @endif
                            @if (isset($landing_data['cancellation_policy_status']) && $landing_data['cancellation_policy_status']  == 1)
                            <li>
                                <a href="{{ $baseUrl }}/cancelation">{{ translate('messages.Cancelation Policy') }}</a>
                            </li>
                            @endif
