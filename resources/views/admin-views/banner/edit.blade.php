                            ...
                            <div class="row g-3">
                                <div class="col-lg-6">
                                    @if($language)
                                        ...
                                        <div class="lang_form" id="default-form">
                                            <div class="form-group">
                                              ...
                                              <div class="form-group">
                                                <label class="input-label" for="default_sub_title">{{translate('messages.sub_title')}} ({{translate('messages.default')}})</label>
                                                <input type="text"  name="sub_title[]" id="default_sub_title" class="form-control" placeholder="{{translate('messages.new_banner')}}" value="{{$banner?->getRawOriginal('sub_title')}}" oninvalid="document.getElementById('en-link').click()">
                                            </div>
                                        ...
                                        @foreach($language as $lang)
                                            ...
                                            <div class="d-none lang_form" id="{{$lang}}-form">
                                                <div class="form-group">
                                                  ...
                                                  <div class="form-group">
                                                    <label class="input-label" for="{{$lang}}_sub_title">{{translate('messages.sub_title')}} ({{strtoupper($lang)}})</label>
                                                    <input type="text" name="sub_title[]" id="{{$lang}}_sub_title" class="form-control" placeholder="{{translate('messages.new_banner')}}" value="{{$translate[$lang]['sub_title']??''}}" oninvalid="document.getElementById('en-link').click()">
                                                </div>
                                    ...
                                    <div class="form-group">
										 ...
										 <label class="input-label" for="exampleFormControlInput1">{{translate('Is main')}}</label>
										
                                        <label class="toggle-switch toggle-switch-sm d-flex form-control">
                                      
                                            <input type="checkbox" onclick=""  class="toggle-switch-input"  name="is_main" id="is_main"
                                            {{ $banner->is_main == 1 ? 'checked' : '' }}>
									...
									<div class="form-group">
                                        <label class="input-label" for="exampleFormControlInput1">{{translate('messages.background_color')}}</label>
                                        <input type="color"  name="bg_color" id="bg_color"  class="form-control" value="{{$banner->bg_color}}">
                                    </div>
...
@push('script_2')
    ...
    <script>
		...
		$('input[name="sub_title[]"]').parent().show();
		$('input[name="bg_color"]').parent().show();
		@else
		$('input[name="sub_title[]"]').parent().hide();
		$('input[name="bg_color"]').parent().hide();
		@endif
