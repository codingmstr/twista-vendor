                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="lang_form" id="default-form">
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            <label class="input-label"
                                                for="default_sub_title">{{ translate('messages.sub_title') }}
                                                (Default)
                                            </label>
                                            <input type="text" name="sub_title[]" id="default_sub_title"
                                                class="form-control" placeholder="{{ translate('messages.new_banner') }}">
                                        </div>
                                        ...
                                        @foreach ($language as $lang)
                                            <div class="d-none lang_form"
                                                ...
                                                <div class="form-group">
                                                    <label class="input-label"
                                                        for="{{ $lang }}_sub_title">{{ translate('messages.sub_title') }}
                                                        ({{ strtoupper($lang) }})
                                                    </label>
                                                    <input type="text" name="sub_title[]" id="{{ $lang }}_sub_title"
                                                        class="form-control" placeholder="{{ translate('messages.new_banner') }}"
